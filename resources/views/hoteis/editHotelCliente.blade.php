...
@section('content')
    ...
    @endif
        ...
        {!! Form::open(['route'=>['hoteis.update', $hotel->id], 'class'=>'form-horizontal', 'method'=>'put']) !!}
        ...
        <div class="form-group">
            ...
            <span class="campo_obrigatorio">
            <label for="valorHotelCliente" class="col-md-2 control-label">Valor Extra R$ </label>
            </span>
                <div class="col-sm-2">
                <input class="form-control" id="valor_extra" name="valor_extra"  value="{{$hotel->valor_extra}}" />
            </div>
        </div>
