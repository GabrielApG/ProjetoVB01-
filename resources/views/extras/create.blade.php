...
@section('content')
    ...
    <div class="container">
        ...
        {!! Form::open(['route'=>'extras.store', 'class'=>'form-horizontal']) !!}
        ...
        <div class="form-group">
            ...
            <label for="paisCreateTransfers" class="col-md-2 control-label">Destino</label>
            <div class="col-sm-2">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-2">
                {!! Form::text('empresa_extra', null, ['class'=>'form-control']) !!}
            </div>
