...
@section('content')
    ...
    <ul class="nav nav-tabs">
        ...
        <li role="presentation" class="active"><a href="{{ route('extras') }}"><span class="glyphicon glyphicon-king"></span> Extras</a></li>
    ...
    <div class="alert alert-warning alert-dismissible" role="alert">
        <strong>Atenção!</strong> Os Extras cadastrados aqui, serão disponibilizados apenas para ciclo de orçamento.
    </div>

    <div class="form-group">
    <a href="{{ route('extras.create')}}" class="btn-sm  btn-success"><span class="glyphicon glyphicon-plus-sign"></span> Cadastrar Extras para Orçamento</a>
    </div>
    ...
    <table class="table table-striped table-bordered table-hover">
        ...
        <tr class="text-center">
            ...
            <td>{{ $e->valor }}</td>
            <td class="acoes">
                <a href="{{ route('extras.edit',['id'=>$e->id]) }}" name="edit" class="btn-xs btn-warning"><span class="glyphicon glyphicon-pencil"></span> </a>
            </td>
            <td class="acoes"><a href="{{ route('extras.edit',['id'=>$e->id]) }}" name="excluir" class="btn-xs btn-danger"><span class="glyphicon glyphicon-trash "></span> </a></td>
        </tr>
        <?php }?>
        @endforeach
        </tbody>
