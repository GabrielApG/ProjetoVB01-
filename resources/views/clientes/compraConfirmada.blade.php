...
@section('content')
    ...
    <ul class="nav nav-tabs">
        ...
        <li role="presentation" class="active"><a href="{{ route('clientes.compraConfirmada')}}"><span class="glyphicon glyphicon-warning-sign">
    ...
    <div class="alert alert-success" role="alert">
        <strong>ATENÇÃO! Clientes</strong> que realizaram a compra.
    </div>
