...
@section('content')
    ...
    <ul class="nav nav-tabs">
        ...
        <li role="presentation" class="active"><a href="{{route('clientes.emViajem')}}"><span class="glyphicon glyphicon-plane">
    ...
    <div class="alert alert-danger" role="alert">
        <strong>ATENÇÃO!</strong> Clientes em Viagem.
    </div>
    ...
    {{--<div class="input-group input-group-sm">--}}
        ...
        {{--<input type="text" class="form-control"name="busca" id="busca" placeholder="Buscar por ..."  onkeyup="buscarNoticias(this.value)" aria-describedby="sizing-addon3">--}}
    {{--</div>--}}
