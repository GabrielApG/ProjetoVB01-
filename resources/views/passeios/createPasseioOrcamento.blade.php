...
@section('content')
    ...
    <div class="container">
    <legend>Cadastrar novo Passeio</legend><br />
    ...
    @endif
        ...
        <div class="form-group">
            <label for="paisCreatePasseiosOrcamento" class="col-md-2 control-label">País <span class="campo_obrigatorio">*</span></label>
            <div class="col-sm-2">
                {!! Form::select('pais', $paises, null, ['class'=>'form-control', 'id'=>'paisCreatePasseiosOrcamento']) !!}
            </div>

            <label for="cidadesidCreatePasseiosOrcamento" class="col-md-2 control-label">Cidade <span class="campo_obrigatorio">*</span></label>
            <div class="col-sm-2">
                {!! Form::select('cidades_id', [], null, ['class'=>'form-control', 'id'=>'cidadesidCreatePasseiosOrcamento']) !!}
            </div>
        </div>
        ...
        <div class="form-group">
            <label for="trensidCreatePasseiosOrcamento" class="col-md-2 control-label">Trens <span class="campo_obrigatorio">*</span></label>
            <div class="col-sm-2">
                {!! Form::select('trens_id', [], null, ['class'=>'form-control', 'id'=>'trensidCreatePasseioOrcamento']) !!}
            </div>
        </div>
